...
accelerate launch PPO_PG/PPO.py \
    ...
    --reward_model_name="Llama-2-7b-hf_peft_stack-exchange-paired_rmts__100000_2e-05_peft_last_checkpoint" \
    --adafactor=False \
    --save_freq=100 \
...
tokenizer = AutoTokenizer.from_pretrained(script_args.tokenizer_name, token=access_token)
