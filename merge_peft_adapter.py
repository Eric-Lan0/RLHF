...
python merge_peft_adapter.py \
    ...
    --adapter_model_name="DPO/dpo_tuned/final_checkpoint" \
...
tokenizer = AutoTokenizer.from_pretrained(script_args.base_model_name, token=access_token)
...
# model.push_to_hub(f"{script_args.output_name}", token=access_token, use_temp_dir=False)
